...
void loop() {
  ...
  if (carril == 2 && direccion == 1 && count == 0) {
    move(2, 70 / 100.0 * 255);
    delay(1000);
   if (count == 0) {
    if (ultrasonic_3.distanceCm() < 95) {
  ...
  if (carril == 2 && direccion == 1 && count == 1) {
    move(1, 80 / 100.0 * 255);
   while(1) {
  ...
  if (carril == 3 && direccion == 2 && count == 0) {
    move(2, 70 / 100.0 * 255);
    delay(1000);
   if (count == 0) {
    if (ultrasonic_4.distanceCm() < 95) {
     count = 1;
    }
   }
  }
  ...
  if (carril == 3 && direccion == 2 && count == 1) {
   move(1, 80 / 100.0 * 255);
  while(1) {
